...
public class SQLConnection {
	 ...
	 * @param gain            int for gains
	 */
	protected void updateHive(String username, String apiary, String oldhive, String newhive, String inspection,
			String health, String honey, String queenproduction, String equiphive, String equipinven, int loss,
			int gain) {
	...
	protected void editPreference(String username, boolean inspection, boolean health, boolean honey,
			boolean queenproduction, boolean equiphive, boolean equipinven, boolean loss, boolean gain) {
		try {
